    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h12, file$2, 44, 0, 1477);
    			add_location(h30, file$2, 46, 0, 1514);
    			add_location(li7, file$2, 48, 4, 1537);
    			add_location(li8, file$2, 51, 4, 1814);
    			add_location(li9, file$2, 54, 4, 1986);
    			add_location(ul1, file$2, 47, 0, 1528);
    			if (!src_url_equal(img1.src, img1_src_value = "pictures/model_residual.jpg")) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "class", "rounded mx-auto d-block");
    			set_style(img1, "width", "1000px");
    			set_style(img1, "height", "auto");
    			attr_dev(img1, "alt", "...");
    			add_location(img1, file$2, 59, 0, 2125);
    			add_location(h31, file$2, 67, 0, 2264);
    			add_location(li10, file$2, 70, 4, 2437);
    			add_location(li11, file$2, 73, 4, 2538);
    			add_location(li12, file$2, 76, 4, 2653);
    			add_location(ul2, file$2, 69, 0, 2428);
    			if (!src_url_equal(img2.src, img2_src_value = "pictures/model_comparison.jpg")) attr_dev(img2, "src", img2_src_value);
    			attr_dev(img2, "class", "rounded mx-auto d-block");
    			set_style(img2, "width", "1000px");
    			set_style(img2, "height", "auto");
    			attr_dev(img2, "alt", "...");
    			add_location(img2, file$2, 80, 0, 2769);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
