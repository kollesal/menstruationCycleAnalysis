...
var app = (function () {
    ...
    const file$4 = "src/pages/Mens.svelte";
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "alt", "...");
    			add_location(img, file$4, 142, 2, 2922);
    			attr_dev(div21, "class", "row justify-content-md-center");
    			add_location(div21, file$4, 141, 1, 2876);
    			attr_dev(div22, "class", "container text-center");
    			add_location(div22, file$4, 38, 0, 680);
    		},
    		l: function claim(nodes) {
    ...
    const file$3 = "src/pages/Data.svelte";
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			img16 = element("img");
    			add_location(h10, file$3, 6, 4, 120);
    			add_location(h2, file$3, 7, 4, 165);
    			add_location(h30, file$3, 8, 4, 194);
    			add_location(p0, file$3, 9, 4, 238);
    			add_location(li0, file$3, 17, 8, 521);
    			add_location(li1, file$3, 22, 8, 756);
    			add_location(li2, file$3, 34, 8, 1541);
    			add_location(li3, file$3, 38, 8, 1665);
    			add_location(ul0, file$3, 16, 4, 508);
    			add_location(h31, file$3, 48, 4, 2143);
    			add_location(p1, file$3, 50, 4, 2187);
    			add_location(li4, file$3, 52, 8, 2274);
    			add_location(li5, file$3, 53, 8, 2343);
    			add_location(li6, file$3, 57, 8, 2513);
    			add_location(li7, file$3, 62, 8, 2716);
    			add_location(li8, file$3, 72, 8, 3353);
    			add_location(ul1, file$3, 51, 4, 2261);
    			attr_dev(div0, "class", "col-md-8");
    			add_location(div0, file$3, 80, 4, 3694);
    			add_location(h32, file$3, 82, 4, 3724);
    			attr_dev(a0, "href", "https://www.kaggle.com/datasets/nikitabisht/menstrual-cycle-data");
    			add_location(a0, file$3, 85, 60, 3838);
    			add_location(li9, file$3, 84, 8, 3773);
    			add_location(li10, file$3, 90, 8, 4006);
    			add_location(li11, file$3, 91, 8, 4051);
    			attr_dev(a1, "href", "https://www.mynfp.de/nfp-regeln");
    			add_location(a1, file$3, 94, 69, 4282);
    			add_location(li12, file$3, 92, 8, 4128);
    			attr_dev(div1, "class", "col-md-8");
    			add_location(div1, file$3, 99, 8, 4384);
    			...
    			attr_dev(img0, "alt", "...");
    			add_location(img0, file$3, 101, 12, 4473);
    			attr_dev(div2, "class", "row justify-content-md-center");
    			add_location(div2, file$3, 100, 8, 4417);
    			add_location(ul2, file$3, 83, 4, 3760);
    			add_location(h33, file$3, 109, 4, 4639);
    			add_location(li13, file$3, 111, 8, 4676);
    			add_location(li14, file$3, 116, 8, 4941);
    			add_location(li15, file$3, 120, 8, 5087);
    			attr_dev(div3, "class", "col-md-8");
    			add_location(div3, file$3, 128, 8, 5458);
    			...
    			attr_dev(img1, "alt", "...");
    			add_location(img1, file$3, 130, 12, 5547);
    			attr_dev(div4, "class", "row justify-content-md-center");
    			add_location(div4, file$3, 129, 8, 5491);
    			add_location(ul3, file$3, 110, 4, 4663);
    			add_location(h34, file$3, 138, 4, 5713);
    			add_location(li16, file$3, 140, 8, 5750);
    			add_location(li17, file$3, 144, 8, 5896);
    			add_location(li18, file$3, 148, 8, 6022);
    			add_location(p2, file$3, 152, 8, 6199);
    			...
    			attr_dev(img2, "alt", "...");
    			add_location(img2, file$3, 154, 12, 6269);
    			attr_dev(div5, "class", "row justify-content-md-center");
    			add_location(div5, file$3, 153, 8, 6213);
    			add_location(p3, file$3, 160, 8, 6428);
    			add_location(p4, file$3, 164, 12, 6515);
    			add_location(li19, file$3, 162, 8, 6443);
    			...
    			attr_dev(img3, "alt", "...");
    			add_location(img3, file$3, 168, 12, 6600);
    			attr_dev(div6, "class", "row justify-content-md-center");
    			add_location(div6, file$3, 167, 8, 6544);
    			add_location(ul4, file$3, 139, 4, 5737);
    			add_location(h11, file$3, 176, 4, 6769);
    			add_location(h35, file$3, 177, 4, 6799);
    			...
    			attr_dev(img4, "alt", "...");
    			add_location(img4, file$3, 181, 12, 6943);
    			add_location(li20, file$3, 179, 8, 6848);
    			add_location(li21, file$3, 187, 8, 7107);
    			...
    			attr_dev(img5, "alt", "...");
    			add_location(img5, file$3, 199, 12, 7784);
    			add_location(li22, file$3, 196, 8, 7670);
    			add_location(ul5, file$3, 178, 4, 6835);
    			add_location(h12, file$3, 207, 4, 7960);
    			add_location(h36, file$3, 209, 4, 7991);
    			...
    			attr_dev(img6, "alt", "...");
    			add_location(img6, file$3, 215, 12, 8186);
    			add_location(li23, file$3, 212, 8, 8029);
    			...
    			attr_dev(img7, "alt", "...");
    			add_location(img7, file$3, 225, 12, 8474);
    			add_location(li24, file$3, 222, 8, 8355);
    			...
    			attr_dev(img8, "alt", "...");
    			add_location(img8, file$3, 234, 12, 8748);
    			add_location(li25, file$3, 231, 8, 8637);
    			add_location(ul6, file$3, 211, 4, 8016);
    			add_location(h13, file$3, 242, 4, 8919);
    			...
    			attr_dev(img9, "alt", "...");
    			add_location(img9, file$3, 246, 12, 9046);
    			add_location(li26, file$3, 244, 8, 8959);
    			...
    			attr_dev(img10, "alt", "...");
    			add_location(img10, file$3, 255, 12, 9297);
    			add_location(li27, file$3, 253, 8, 9215);
    			...
    			attr_dev(img11, "alt", "...");
    			add_location(img11, file$3, 263, 12, 9532);
    			add_location(li28, file$3, 261, 8, 9464);
    			add_location(ul7, file$3, 243, 4, 8946);
    			add_location(h14, file$3, 271, 4, 9707);
    			...
    			attr_dev(img12, "alt", "...");
    			add_location(img12, file$3, 276, 12, 9924);
    			add_location(li29, file$3, 273, 8, 9753);
    			...
    			attr_dev(img13, "alt", "...");
    			add_location(img13, file$3, 285, 12, 10146);
    			add_location(li30, file$3, 283, 8, 10090);
    			...
    			attr_dev(img14, "alt", "...");
    			add_location(img14, file$3, 296, 12, 10617);
    			add_location(li31, file$3, 291, 8, 10312);
    			...
    			attr_dev(img15, "alt", "...");
    			add_location(img15, file$3, 305, 12, 10905);
    			add_location(li32, file$3, 302, 8, 10786);
    			...
    			attr_dev(img16, "alt", "...");
    			add_location(img16, file$3, 313, 12, 11127);
    			add_location(li33, file$3, 311, 8, 11070);
    			add_location(ul8, file$3, 272, 4, 9740);
    			attr_dev(div7, "class", "container");
    			add_location(div7, file$3, 5, 0, 92);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$2 = "src/pages/Motivation.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 5, 4, 96);
    			add_location(h20, file$2, 6, 4, 120);
    			...
    			add_location(button0, file$2, 12, 12, 333);
    			attr_dev(h21, "class", "accordion-header");
    			attr_dev(h21, "id", "panelsStayOpen-headingOne");
    			add_location(h21, file$2, 11, 10, 260);
    			add_location(h40, file$2, 18, 16, 768);
    			add_location(li0, file$2, 20, 20, 833);
    			add_location(li1, file$2, 24, 20, 1012);
    			add_location(li2, file$2, 28, 20, 1209);
    			add_location(li3, file$2, 32, 20, 1389);
    			add_location(li4, file$2, 33, 20, 1456);
    			add_location(li5, file$2, 42, 20, 2014);
    			add_location(li6, file$2, 47, 20, 2262);
    			add_location(p0, file$2, 56, 20, 2717);
    			...
    			attr_dev(img0, "alt", "...");
    			add_location(img0, file$2, 57, 20, 2743);
    			add_location(ul0, file$2, 19, 16, 808);
    			add_location(h41, file$2, 65, 16, 3017);
    			add_location(li7, file$2, 67, 20, 3084);
    			add_location(li8, file$2, 68, 20, 3151);
    			add_location(li9, file$2, 69, 20, 3212);
    			add_location(ul1, file$2, 66, 16, 3059);
    			attr_dev(div0, "class", "accordion-body svelte-1vj9bvn");
    			add_location(div0, file$2, 17, 12, 723);
    			...
    			add_location(div1, file$2, 16, 10, 588);
    			attr_dev(div2, "class", "accordion-item");
    			add_location(div2, file$2, 10, 8, 221);
    			...
    			add_location(button1, file$2, 79, 12, 3510);
    			attr_dev(h22, "class", "accordion-header");
    			attr_dev(h22, "id", "panelsStayOpen-headingTwo");
    			add_location(h22, file$2, 78, 10, 3437);
    			add_location(h42, file$2, 85, 16, 3962);
    			attr_dev(a, "href", "https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7916245/");
    			add_location(a, file$2, 89, 62, 4168);
    			add_location(li10, file$2, 87, 20, 4031);
    			add_location(li11, file$2, 94, 20, 4370);
    			add_location(li12, file$2, 101, 20, 4752);
    			add_location(li13, file$2, 108, 20, 5140);
    			add_location(li14, file$2, 112, 20, 5321);
    			add_location(li15, file$2, 116, 20, 5504);
    			add_location(li16, file$2, 121, 20, 5744);
    			add_location(li17, file$2, 126, 20, 6002);
    			add_location(p1, file$2, 130, 20, 6249);
    			if (!src_url_equal(img1.src, img1_src_value = "pictures/cycle_phases_mood.png")) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "class", "rounded mx-auto d-block");
    			attr_dev(img1, "alt", "...");
    			add_location(img1, file$2, 131, 20, 6275);
    			add_location(ul2, file$2, 86, 16, 4006);
    			attr_dev(div3, "class", "accordion-body svelte-1vj9bvn");
    			add_location(div3, file$2, 84, 12, 3917);
    			...
    			add_location(div4, file$2, 83, 10, 3787);
    			attr_dev(div5, "class", "accordion-item");
    			add_location(div5, file$2, 77, 8, 3398);
    			...
    			add_location(button2, file$2, 142, 12, 6643);
    			attr_dev(h23, "class", "accordion-header");
    			attr_dev(h23, "id", "panelsStayOpen-headingThree");
    			add_location(h23, file$2, 141, 10, 6568);
    			add_location(h43, file$2, 148, 16, 7106);
    			add_location(li18, file$2, 150, 20, 7178);
    			add_location(li19, file$2, 153, 20, 7318);
    			add_location(li20, file$2, 156, 20, 7454);
    			add_location(li21, file$2, 159, 20, 7627);
    			add_location(ul3, file$2, 149, 16, 7153);
    			attr_dev(div6, "class", "accordion-body svelte-1vj9bvn");
    			add_location(div6, file$2, 147, 12, 7061);
