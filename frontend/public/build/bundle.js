...
var app = (function () {
    ...
    const file$1 = "src/pages/Mens.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div20 = element("div");
    			img = element("img");
    			add_location(h10, file$1, 40, 1, 718);
    			attr_dev(div0, "class", "col-md-8");
    			add_location(div0, file$1, 41, 1, 747);
    			add_location(h11, file$1, 42, 1, 773);
    			attr_dev(div1, "class", "col-md-12");
    			add_location(div1, file$1, 46, 1, 875);
    			attr_dev(div2, "class", "col col-lg-3");
    			add_location(div2, file$1, 48, 2, 948);
    			attr_dev(label0, "for", "Age");
    			add_location(label0, file$1, 50, 3, 1009);
    			attr_dev(input0, "type", "number");
    			attr_dev(input0, "class", "form-control");
    			attr_dev(input0, "placeholder", "Age");
    			attr_dev(input0, "aria-label", "Age");
    			add_location(input0, file$1, 51, 3, 1041);
    			attr_dev(div3, "class", "col col-lg-2");
    			add_location(div3, file$1, 49, 2, 979);
    			attr_dev(label1, "for", "Weight");
    			add_location(label1, file$1, 60, 3, 1202);
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "class", "form-control");
    			attr_dev(input1, "placeholder", "Weight");
    			attr_dev(input1, "aria-label", "Weight");
    			add_location(input1, file$1, 61, 3, 1240);
    			attr_dev(div4, "class", "col col-lg-2");
    			add_location(div4, file$1, 59, 2, 1172);
    			attr_dev(label2, "for", "Height");
    			add_location(label2, file$1, 70, 3, 1410);
    			attr_dev(input2, "type", "number");
    			attr_dev(input2, "class", "form-control");
    			attr_dev(input2, "placeholder", "Height");
    			attr_dev(input2, "aria-label", "Height");
    			add_location(input2, file$1, 71, 3, 1448);
    			attr_dev(div5, "class", "col col-lg-2");
    			add_location(div5, file$1, 69, 2, 1380);
    			attr_dev(label3, "for", "BMI");
    			add_location(label3, file$1, 80, 3, 1618);
    			attr_dev(input3, "type", "text");
    			input3.readOnly = true;
    			attr_dev(input3, "class", "form-control-plaintext");
    			attr_dev(input3, "aria-label", "BMI");
    			input3.value = /*bmi*/ ctx[5];
    			add_location(input3, file$1, 81, 3, 1650);
    			attr_dev(div6, "class", "col col-lg-2");
    			add_location(div6, file$1, 79, 2, 1588);
    			attr_dev(div7, "class", "col col-lg-1");
    			add_location(div7, file$1, 89, 2, 1775);
    			attr_dev(div8, "class", "col-md-8");
    			add_location(div8, file$1, 90, 2, 1806);
    			attr_dev(div9, "class", "col col-lg-4");
    			add_location(div9, file$1, 91, 2, 1833);
    			attr_dev(div10, "class", "col col-lg-2");
    			add_location(div10, file$1, 92, 2, 1864);
    			attr_dev(label4, "for", "length");
    			add_location(label4, file$1, 94, 3, 1925);
    			add_location(p, file$1, 95, 3, 1951);
    			attr_dev(div11, "class", "col col-lg-2");
    			add_location(div11, file$1, 93, 2, 1895);
    			attr_dev(label5, "for", "cycle");
    			add_location(label5, file$1, 99, 3, 2010);
    			attr_dev(input4, "type", "number");
    			attr_dev(input4, "class", "form-control");
    			attr_dev(input4, "placeholder", "in Days");
    			attr_dev(input4, "aria-label", "cycle");
    			add_location(input4, file$1, 100, 3, 2054);
    			attr_dev(div12, "class", "col col-lg-2");
    			add_location(div12, file$1, 98, 2, 1980);
    			attr_dev(label6, "for", "mens");
    			add_location(label6, file$1, 109, 3, 2231);
    			attr_dev(input5, "type", "number");
    			attr_dev(input5, "class", "form-control");
    			attr_dev(input5, "placeholder", "in Days");
    			attr_dev(input5, "aria-label", "Mens");
    			add_location(input5, file$1, 110, 3, 2284);
    			attr_dev(div13, "class", "col col-lg-2");
    			add_location(div13, file$1, 108, 2, 2201);
    			attr_dev(div14, "class", "col col-lg-4");
    			add_location(div14, file$1, 118, 2, 2429);
    			attr_dev(div15, "class", "col-md-8");
    			add_location(div15, file$1, 120, 2, 2461);
    			attr_dev(div16, "class", "col col-lg-4");
    			add_location(div16, file$1, 121, 2, 2488);
    			attr_dev(button, "type", "button");
    			attr_dev(button, "class", "my-button");
    			add_location(button, file$1, 124, 3, 2550);
    			attr_dev(div17, "class", "col col-lg-2");
    			add_location(div17, file$1, 123, 2, 2520);
    			attr_dev(div18, "class", "row justify-content-md-center");
    			add_location(div18, file$1, 47, 1, 902);
    			attr_dev(div19, "class", "col-md-8");
    			add_location(div19, file$1, 134, 1, 2728);
    			if (!src_url_equal(img.src, img_src_value = "cycle.png")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "class", "rounded mx-auto d-block");
    			attr_dev(img, "alt", "...");
    			add_location(img, file$1, 136, 2, 2800);
    			attr_dev(div20, "class", "row justify-content-md-center");
    			add_location(div20, file$1, 135, 1, 2754);
    			attr_dev(div21, "class", "container text-center");
    			add_location(div21, file$1, 39, 0, 681);
    		},
    		l: function claim(nodes) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			li1 = element("li");
    			a1 = element("a");
    			a1.textContent = "Menstruation Regression";
    			t3 = space();
    			div3 = element("div");
    			create_component(router.$$.fragment);
    			attr_dev(a0, "class", "nav-link");
    			attr_dev(a0, "href", "#/");
    			add_location(a0, file, 13, 6, 403);
    			attr_dev(li0, "class", "nav-item");
    			add_location(li0, file, 12, 5, 375);
    			attr_dev(a1, "class", "nav-link");
    			attr_dev(a1, "href", "#/mens");
    			add_location(a1, file, 16, 6, 490);
    			attr_dev(li1, "class", "nav-item");
    			add_location(li1, file, 15, 5, 462);
    			attr_dev(ul, "class", "navbar-nav");
    			add_location(ul, file, 11, 4, 346);
    			attr_dev(div0, "class", "collapse navbar-collapse");
    			attr_dev(div0, "id", "navbarNavDropdown");
    			add_location(div0, file, 10, 3, 280);
    			attr_dev(div1, "class", "container-fluid");
    			add_location(div1, file, 9, 2, 247);
    			attr_dev(nav, "class", "navbar nav-fill w-100 navbar-expand-lg navbar-light bg-light");
    			add_location(nav, file, 8, 1, 170);
    			attr_dev(div2, "class", "navigation container");
    			add_location(div2, file, 7, 0, 133);
    			attr_dev(div3, "class", "container mt-3");
    			add_location(div3, file, 25, 0, 610);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
