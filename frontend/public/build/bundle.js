    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = space();
    			h30 = element("h3");
    			h30.textContent = "End users";
    			t5 = space();
    			h4 = element("h4");
    			h4.textContent = "Considerations";
    			t7 = space();
    			ul0 = element("ul");
    			li0 = element("li");
    			li0.textContent = "The End Users of this application are women that have an active menstrual cycle";
    			t9 = space();
    			li1 = element("li");
    			li1.textContent = "The women must be in a post-puberty state and before the menopause. (approx. Age between 14 - 50)";
    			t11 = space();
    			li2 = element("li");
    			li2.textContent = "Pregnant woman also can't be included, as they normally don't have their period.";
    			t13 = space();
    			li3 = element("li");
    			li3.textContent = "The women must be biologically female";
    			t15 = space();
    			li4 = element("li");
    			li4.textContent = "The menstrual cycle doesn't has to be constant. It's important, that the women have a cycle. \n            Especially after discontinuing a hormonal contraception method, the menstrual cycle can be quite irregular. \n            This is not a problem. But if the person doesn't have the menstruation at all, the prediction will not work, as there is no active cycle.";
    			t17 = space();
    			li5 = element("li");
    			li5.textContent = "Also, the women want to know how their body works and is interested to learn about the menstrual cycle / is already familiar";
    			t19 = space();
    			li6 = element("li");
    			li6.textContent = "There are already quite a lot of contraceptives. The tracking of the menstrual cycle doesn't has to be for a contraception method. It can also be done additionally to another contraception method just to get to know in what cycle phase the body is right now.";
    			t21 = space();
    			p0 = element("p");
    			t22 = space();
    			img0 = element("img");
    			t23 = space();
    			h31 = element("h3");
    			h31.textContent = "Final End Users:";
    			t25 = space();
    			ul1 = element("ul");
    			li7 = element("li");
    			...
    			t31 = space();
    			h32 = element("h3");
    			h32.textContent = "Goals of end users";
    			t33 = space();
    			ul2 = element("ul");
    			li10 = element("li");
    			t34 = text("There are studies that show the impact of the menstrual cycle in relation to sport: ");
    			a = element("a");
    			a.textContent = "Study";
    			t36 = space();
    			li11 = element("li");
    			li11.textContent = "The menstrual cycle is influencing the thoughts and feelings and body (temparature, skin, etc.) of women. So the body is giving clear indication to";
    			t38 = space();
    			li12 = element("li");
    			li12.textContent = "Pregnant woman also can't be included, as they normally don't have their period.";
    			t40 = space();
    			li13 = element("li");
    			li13.textContent = "The women must be biologically female";
    			t42 = space();
    			li14 = element("li");
    			li14.textContent = "The menstrual cycle doesn't has to be constant. It's important, that the women have a cycle. \n            Especially after discontinuing a hormonal contraception method, the menstrual cycle can be quite irregular. \n            This is not a problem. But if the person doesn't have the menstruation at all, the prediction will not work, as there is no active cycle.";
    			t44 = space();
    			li15 = element("li");
    			li15.textContent = "Also, the women want to know how their body works and is interested to learn about the menstrual cycle / is already familiar";
    			t46 = space();
    			li16 = element("li");
    			li16.textContent = "There are already quite a lot of contraceptives. The tracking of the menstrual cycle doesn't has to be for a contraception method. It can also be done additionally to another contraception method just to get to know in what cycle phase the body is right now.";
    			t48 = space();
    			p1 = element("p");
    			t49 = space();
    			img1 = element("img");
    			t50 = space();
    			h33 = element("h3");
    			h33.textContent = "Obstacle to be solved";
    			add_location(h1, file$1, 6, 4, 120);
    			add_location(h2, file$1, 7, 4, 144);
    			add_location(h30, file$1, 8, 4, 175);
    			add_location(h4, file$1, 9, 4, 198);
    			add_location(li0, file$1, 11, 8, 239);
    			add_location(li1, file$1, 15, 8, 359);
    			add_location(li2, file$1, 18, 8, 497);
    			add_location(li3, file$1, 21, 8, 617);
    			add_location(li4, file$1, 24, 8, 694);
    			add_location(li5, file$1, 29, 8, 1098);
    			add_location(li6, file$1, 32, 8, 1263);
    			add_location(p0, file$1, 37, 0, 1560);
    			...
    			attr_dev(img0, "alt", "...");
    			add_location(img0, file$1, 38, 8, 1576);
    			add_location(ul0, file$1, 10, 4, 226);
    			add_location(h31, file$1, 46, 4, 1754);
    			add_location(li7, file$1, 48, 4, 1789);
    			add_location(li8, file$1, 51, 4, 1854);
    			add_location(li9, file$1, 54, 4, 1913);
    			add_location(ul1, file$1, 47, 0, 1780);
    			add_location(h32, file$1, 59, 4, 1996);
    			attr_dev(a, "href", "https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7916245/");
    			add_location(a, file$1, 62, 96, 2142);
    			add_location(li10, file$1, 61, 8, 2041);
    			add_location(li11, file$1, 65, 8, 2239);
    			add_location(li12, file$1, 68, 8, 2427);
    			add_location(li13, file$1, 71, 8, 2547);
    			add_location(li14, file$1, 74, 8, 2624);
    			add_location(li15, file$1, 79, 8, 3028);
    			add_location(li16, file$1, 82, 8, 3193);
    			add_location(p1, file$1, 87, 0, 3490);
    			if (!src_url_equal(img1.src, img1_src_value = "pictures/cycle_phases_mood.png")) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "class", "rounded mx-auto d-block");
    			attr_dev(img1, "alt", "...");
    			add_location(img1, file$1, 88, 8, 3506);
    			add_location(ul2, file$1, 60, 4, 2028);
    			add_location(h33, file$1, 97, 4, 3649);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div1, file, 31, 0, 919);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
